...
\input{deskripsi/judul-en.tex}
\input{deskripsi/abstrak-en.tex}

% Ubah bagian berikut sesuai dengan konten-konten yang akan dimasukkan pada dokumen
\input{konten/en/1-introduction.tex}
\input{konten/en/2-literature-review.tex}
\input{konten/en/3-design-and-implementation.tex}
\input{konten/en/4-result-discussion.tex}
\input{konten/en/5-conclusion.tex}
